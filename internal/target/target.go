...
// name      : Project name
// libProject: Whether to create library project
// noRoot    : Whether to create the project root directory (project name directory)
func Dirs(name string, libProject, noRoot bool) []string {
	dirs := []string{}
	if noRoot {
...
func Files(name string, libProject, noRoot bool) map[string]string {
	...
	path, code := testFile(name, libProject, noRoot)
	files[path] = code

	path, code = docGoFile(name, libProject, noRoot)
	files[path] = code

	path, code = makefile(name, libProject, noRoot)
	files[path] = code
...
func testFile(name string, libProject, noRoot bool) (string, string) {
	code := `package XXX_PKG_XXX
...
func docGoFile(name string, libProject, noRoot bool) (string, string) {
...
func makefile(name string, libProject, noRoot bool) (string, string) {
	var path string
	if noRoot {
		path = "Makefile"
	} else {
